...
export const synonymMap: Record<string, string[]> = {
  "stuck": ["Career", "Purpose", "Motivation", "Ambition", "Priorities"],
  "career": ["Career", "Work", "Ambition", "Purpose", "Success", "Learning"],
  "job": ["Career", "Work", "Hiring", "Success"],
  "work": ["Work", "Career", "Productivity", "Leadership", "Quality"],
  ...
  "overwhelm": ["Overwhelmed", "Productivity", "Priorities", "Mental Health", "Habits"],
  "busy": ["Productivity", "Time Management", "Priorities", "Overwhelmed", "Work"],
  ...
  "direction": ["Purpose", "Ambition", "Decision Making", "Priorities"],
  "lost": ["Purpose", "Mental Health", "Motivation", "Life", "Anxiety"],
  "confused": ["Decision Making", "Purpose", "Thinking", "Anxiety"],
  ...
  "dream": ["Ambition", "Purpose", "Motivation", "Success", "Procrastination"],
  "success": ["Success", "Ambition", "Habits", "Perseverance", "Work", "Outcomes"],
  "ambition": ["Ambition", "Purpose", "Success", "Motivation", "Career"],
  "goal": ["Ambition", "Priorities", "Habits", "Success", "Outcomes", "Procrastination"],
  ...
  "team": ["Leadership", "People", "Communication", "Trust", "Work"],
  "boss": ["Leadership", "Work", "Communication", "People", "Influence"],
  "employee": ["Leadership", "Hiring", "People", "Trust", "Work"],
  "delegate": ["Leadership", "Trust", "People", "Productivity", "Work"],
  ...
  "lazy": ["Procrastination", "Habits", "Motivation", "Willpower", "Productivity"],
  "energy": ["Habits", "Health", "Motivation", "Productivity", "Willpower"],
  "routine": ["Habits", "Productivity", "Time Management", "Willpower", "Success"],
  "procrastinat": ["Procrastination", "Habits", "Willpower", "Motivation", "Productivity"],
  "delay": ["Procrastination", "Habits", "Time Management", "Willpower", "Priorities"],
  "distract": ["Procrastination", "Productivity", "Habits", "Time Management"],
  "focus": ["Productivity", "Habits", "Time Management", "Priorities", "Willpower"],
  "productiv": ["Productivity", "Habits", "Time Management", "Work", "Priorities"],
  "time": ["Time Management", "Productivity", "Priorities", "Habits", "Life"],
  "priorit": ["Priorities", "Time Management", "Decision Making", "Outcomes"],
  ...
  "fear": ["Anxiety", "Perseverance", "Mental Health", "Willpower"],
  "depress": ["Mental Health", "Happiness", "Positivity", "Resilience", "Purpose"],
  "sad": ["Mental Health", "Happiness", "Positivity", "Resilience", "Life"],
  "happy": ["Happiness", "Positivity", "Life", "Desires"],
  "happiness": ["Happiness", "Positivity", "Life", "Desires", "Success"],
  ...
  "rich": ["Money", "Investing", "Success", "Happiness", "Desires"],
  "spend": ["Money", "Habits", "Priorities", "Desires", "Investing"],
  "save": ["Money", "Habits", "Investing", "Priorities", "Willpower"],
  "debt": ["Money", "Investing", "Habits", "Overwhelmed", "Priorities"],
  "learn": ["Learning", "Reading", "Habits", "Teaching"],
  "read": ["Reading", "Learning", "Habits"],
  "teach": ["Teaching", "Learning", "People", "Communication", "Leadership"],
  "grow": ["Learning", "Ambition", "Habits", "Success", "Purpose"],
  "knowledge": ["Learning", "Reading", "Thinking", "Teaching"],
  ...
  "want": ["Desires", "Happiness", "Ambition", "Purpose"],
  "need": ["Desires", "Priorities", "Life", "Happiness", "Purpose"],
  "desire": ["Desires", "Happiness", "Ambition", "Love"],
  ...
  "envy": ["Happiness", "Success", "Desires", "Life", "People"],
...
function getTopicDescription(tag: string): string {
  const map: Record<string, string> = {
    ...
    Procrastination: "Overcoming the habit of delay",
